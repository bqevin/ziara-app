...
?>
<form method="post"action="send_message_action.php">
<span id="span">Message</span><br><textarea name="message"rows="5"cols="40"style='border-radius:5px;border-color:black;'></textarea><br>
