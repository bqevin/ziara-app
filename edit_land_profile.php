...
$qry = "SELECT * FROM land WHERE admin_email = '$my_email'AND land_id='$land_id'";
...
while($row=mysql_fetch_array($retval,MYSQL_ASSOC))
{
  ...
  echo"
  <form method='post'action='edit_land_profile_action.php'>
 <font color='orange'>Name:</font><br><input type='text'name='company'value='{$row['company']}'style='width:300px;'><br>
 ...
 <font color='orange'>Price In Dollars:</font><br><input type='text'name='price'value='{$row['price']}'style='width:300px;'><br>
