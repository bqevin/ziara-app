...
while($row = mysql_fetch_array($results,MYSQL_ASSOC))
{
  ...
  echo"<span id='span'>Name Of Institution:</span><span style='font-size:20px;'>$fname</span><br>";
  echo"<span id='span'>Type Of Centre:</span><span style='font-size:20px;'>$type</span><br>";
