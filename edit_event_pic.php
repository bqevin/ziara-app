...
if(isset($_GET['msg']))
{
  ...
  if($message=2)
  {
    echo"<span style='color:red;'>Image cannot be empty</span>";
   }
 }
 ?>
 <form method="post"action="edit_event_ppic_action.php"enctype="multipart/form-data">
<input type="file"name="image" id="input">
<input type="hidden"name="event_id"value="<?php echo $event_id; ?>">
<input type="submit"value="change"id="submit" name="submit"></form></td></tr></table></body></html>