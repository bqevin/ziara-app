...
while($row = mysql_fetch_array($results,MYSQL_ASSOC))
{
  ...
  echo"<form method='post'action='edit_education_ppic.php'>
  <input type='hidden'name='education_id'value='$education_id'>
  <input type='submit'id='submit'value='change'></form><br>";
  echo"<span id='span'>Name Of Centre:</span><span style='font-size:20px;'>$fname</span><br>";
  echo"<span id='span'>Type Of School:</span><span style='font-size:20px;'>$type</span><br>";
  ...
  echo"<form method='post'action='edit_education.php'>
  <input type='hidden'name='education_id'value='$education_id'>
  <input type='submit'id='submit'value='edit'><br>";
}
?>
