...
if(isset($_GET['msg']))
{
   ...
   if($message==3)
   {
     echo"<span style='color:red;'>Service created successfully!</span>";
   }
 }
 ?>
<form method="post"action="create_service_action.php" enctype="multipart/form-data">
<span id="span">Name Of Business:</span><br><input type="text" id="input" placeholder="Name Of Business"name="fname"><br>
...
$qry = "SELECT * FROM service WHERE admin_email='$email'";
...
while($row = mysql_fetch_array($results,MYSQL_ASSOC))
{
  ...
  echo"<a href='see_service.php?service_id=$service_id'style='color:lime;font-size:20px;text-decoration:none;'>VIEW DETAILS</a>";
