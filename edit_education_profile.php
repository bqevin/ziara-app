...
while($row=mysql_fetch_array($retval,MYSQL_ASSOC))
{
  ...
  echo"
  <form method='post'action='edit_education_profile_action.php'>
 <font color='orange'>Name:</font><br><input type='text'name='centre'value='{$row['centre']}'style='width:300px;'><br>
 <font color='orange'>Type Of Service:</font><br><input type='text'name='service'value='{$row['service']}'style='width:300px;'><br>
 ...
 <font color='orange'>Courses:</font><br><input type='text'name='location'value='{$row['courses']}'style='width:300px;'><br>
