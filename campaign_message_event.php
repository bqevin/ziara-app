...
<form method="post"action="campaign_message_event_action.php"enctype="multipart/form-data">
<input type="hidden"name="receiver_email"value="<?php echo $admin_email;?>">

<font color="orange">Message:</font><br><textarea rows="10"cols="50"placeholder="message..."maxlength="200"name="message"></textarea><br>
