...
?></td>
<td width="5%">
<a href="country.php">Home</a></td>
<td width="2.5%"></td>
<td width="5%">
<a href="Profile.php">Profile</a></td>
<td width="2.5%"></td>
<td width="5%">
<a href="Posts.php">Posts</a></td>
<td width="2.5%"></td>
<?php
...
{
  echo"<td width='5%'><a href='Messages.php'>Messages</a></td><td width='2.5%'></td>";
}
else if(mysql_num_rows($my_messages)!=0)
{
  ...
  {
  echo"<td width='5%'><a href='seen_messages.php?receiver_email=$email'>Messages($number_of_pings)</a></td><td width='2.5%'></td>";
}
}
...
{
  echo"<td width='5%'><a href='Notifications.php'>Notifications</a></td><td width='2.5%'></td>";
}
else if(mysql_num_rows($get_nots)!=0)
{
  ...
  if($actual_number<=0)
  {
   ...
   {
  echo"<td width='5%'><a href='seen_nots.php?status_owner=$email'>Notifications($actual_number)</a></td><td width='2.5%'></td>";
  }
}
?>

<td width='5%'><a href="your_campaigns.php">Campaigns</a></td><td width="2.5%"></td>
<td width='5%'><a href="your_events.php">Events</a></td><td width="1%"></td><td width="1.5%">
...
<font color="FF0099">Say Something:</font><br><textarea rows="5"cols="40"name="status"placeholder="Say Something..."maxlength="1000"></textarea>
...
while($row=mysql_fetch_array($retval,MYSQL_ASSOC))
{
 ...
 ?></td></tr><table></p2>
 <table width="70%"style="border-radius:8px;">
 <tr>
...
<table bgcolor="lime"border="0"bordercolor="white"cellspacing= 0.5 width="70%">
