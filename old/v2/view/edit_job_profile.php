...
while($row=mysql_fetch_array($retval,MYSQL_ASSOC))
{
  ...
  echo"
  <form method='post'action='../controller/action/edit_job_profile_action.php'>
 <font color='orange'>Name:</font><br><input type='text'name='employer'value='{$row['employer']}'><br>
 <font color='orange'>Type Of Service:</font><br><input type='text'name='job'value='{$row['job']}'><br>
