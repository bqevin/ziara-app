...
$query = "SELECT * FROM events WHERE admin_email='$admin_email'";
...
echo"<font color='orange'>Event By:</font><font color='blue'>{$row['owner']}</font><br>
  ...
  <font color='orange'>Location:</font><font color='blue'>{$row['daye']}-{$row['monthe']}-{$row['yeare']}</font><br>
  <form method='post'action='../sessions/view_admin_event_session.php'>
