...
<tr>
<td align="center">
<p>If you want to create an event in <?php echo $_SESSION['country'];?> register your event to help foreigners and residents have
...
and we will build you a dynamic and professional website that suits you.</font></p>
...
<font color="green">Event By:</font><br><input type="text"name="owner"placeholder="Event"style="border-radius:8px;width:200px;"><br>
<font color="green">Type Of Event:</font><br>
<select name="event"style="border-radius:8px;width:200px;">
...
<font color="green">Date Of Event:</font><br><select name="daye"style="border-radius:8px;width:200px;">
...
<select name="monthe"style="border-radius:8px;width:200px;">
...
<select name="yeare"style="border-radius:8px;width:200px;">
...
<font color="green">Location Of Event:</font><br><input type="text"name="location"placeholder="Location"style="border-radius:8px;width:200px;"><br>
...
<p3>
<form method="post"action="../controller/sessions/event_choose_session.php">
<font color="green">Type Of Event:</font><br>
<select name="event"style="border-radius:8px;width:200px;">
<option value="Business">Business</option>
<option value="Charity">Charity</option>
