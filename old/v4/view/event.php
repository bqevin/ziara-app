...
<tr>
<td align="center">
<p><i>If you want to create an event in <?php echo $_SESSION['country'];?> register your event to help foreigners and residents have
...
<h2><font color="red"><i>Take a look at the education centres below</i></font></h2>
<p2></i>If you are visitor in <?php echo $_SESSION['country'];?> you can check for the available education centres below you would wish to see below.</i></p2>
<p3>
