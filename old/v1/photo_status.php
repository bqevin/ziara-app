...
<br><form method="post"action="photo_status_action.php"enctype="multipart/form-data">
<font color="red">status:</font><br><textarea rows="5"cols="40"name="status"placeholder="photo status..."maxlength="200"></textarea><br>
