...
<input type='submit'value='Add Friend'style='background-color:cyan;color:red;border-radius:8px;'>";
}
...
<input type='hidden'name='friend_email'value='$email'>
<input type='hidden'name='country'value='$country'>
<input type='submit'value='Unfriend'style='background-color:cyan;color:red;border-radius:8px;'>";
}
?>
