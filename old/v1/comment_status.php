...
$status_id = $_SESSION['main_status_id'];
...
?></td>
<?php
$get_status_owner = "SELECT * FROM status WHERE status_id='$status_id'";
...
<font color="red">Comment:</font><br><textarea rows="5"cols="50"name="status"placeholder="comment..."maxlength="200"></textarea><br>
...
{
  echo"<a href='edit_main_status_comment.php?id=$id'>Edit</a>";
  echo"&nbsp &nbsp<a href='delete_main_status_comment.php?id=$id'>Delete</a>";
}
}
?>
