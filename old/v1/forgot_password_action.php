...
if(mysql_num_rows($login)>0)
{
  ...
  $conn = mysqli_connect("localhost","amn_ziara","Ziara2015","amn_travel");
  ...
  $message='
	  ...
	  <p style="font-size:16px;">You indicated that you forgot your login password. <p style="font-size:16px;">
