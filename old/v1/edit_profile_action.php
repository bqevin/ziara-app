...
if($email!=$my_email)
{
 ...
 {
if(empty($fname)or empty($lname)or empty($email)or empty($country)or empty($gender)or empty($job)or empty($skills)or empty($religion)or empty($relationship)or empty($kids)or empty($hobbies)or empty($places)or empty($about))
{
   header("Location:edit_profile.php?msg=1");
 }
 else if(!empty($fname)or !empty($lname)or !empty($email)or !empty($country)or !empty($gender)or !empty($job)or !empty($skills)or !empty($religion)or !empty($relationship)or !empty($kids)or !empty($hobbies)or !empty($places)or !empty($about))
{ 
