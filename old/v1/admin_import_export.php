...
$query = "SELECT * FROM import_export WHERE admin_email='$admin_email'";
...
<td style="width:80px;"><a href="your_events.php">Events</a><td style="width:10px;">d>
</td></tr></table>
...
echo"<font color='orange'>Name:</font><font color='blue'>{$row['business']}</font><br>
  ...
  <form method='post'action='view_admin_import_export_session.php'>
