...
if(isset($_GET['msg']))
{
  ...
  ?>
<font color="FF0099">Change Password:</font><form method="post"action="change_password_action.php"><input type="password"name="password"placeholder="input your password"value="">
<input type="submit"value="Submit"style="background-color:cyan;color:red;"></form></td></tr></table></body></html>