...
$query = "SELECT * FROM campaign WHERE admin_email='$admin_email'";
...
?></td><td style="width:80px;"><a href="country.php">Home</a></td><td style="width:10px;"></td>
...
<td style="width:80px;"><a href="your_events.php">Events</a><td style="width:10px;"></td></tr></table>
...
echo"<font color='orange'>Code Name:</font><font color='blue'>{$row['codee']}</font><br>
  ...
  <form method='post'action='view_admin_campaign_session.php'>
