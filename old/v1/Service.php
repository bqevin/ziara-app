...
<tr>
<td align="left">
<p>If you are a resident of <?php echo $_SESSION['country'];?> and you have a business please post it here to help foreignors and residents have
...
?>
<p1>
<form method="post"action="services_action.php"enctype="multipart/form-data">
...
<font color="green">Service:</font><br>
...
<option value="religion">Religios Centers"</option></select><br>
...
<font color="green">Brief description:</font><br><textarea rows="5"cols="40"name="description"placeholder="brief description..."style="border-radius:8px;"maxlength="2000"></textarea><br>
...
<p2></i>If you are visitor in <?php echo $_SESSION['country'];?> you can check for services you would wish to see below.</i></p2>
<p3>
<form method="post"action="services_choose_session.php">
