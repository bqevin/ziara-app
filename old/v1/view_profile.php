...
if($row['gender']=="Female")
{
 echo"<font color='orange'>About Her:</font><font color='blue'>{$row['places']}</font><hr color='orange'size='1'width='100%'>";
}
else
{
 echo"<font color='orange'>About Him:</font><font color='blue'>{$row['places']}</font><hr color='orange'size='1'width='100%'>";
}
