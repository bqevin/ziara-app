...
$query = "SELECT * FROM import_export WHERE import_export_id='$import_export_id'";
...
{ 
   echo'<img src="data:image;base64,'.$row['photo'].'" style="border-radius:50%50%50%50%;width:90px;height:90px;" ><br>';
     echo"<form method='post'action='edit_import_export_profile_pic.php'>
	...
	<form method='post'action='edit_import_export_profile.php'>
