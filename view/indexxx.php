...
<div class="wrapper">
                    ...
                    <div class="full col-sm-9">
                        ...
                        <!-- content -->                      
                         ...
                         <?php
												...
												?>
                              <div class="well"> 
                                   <form class="form-horizontal" method="post" role="form" action="../controller/action/status_action.php">
                                    <h4>Say Something</h4>
                                     <div class="form-group" style="padding:14px;">
                                      <textarea class="form-control" name="status" placeholder="Update your status"></textarea>
                                    </div>
                                    <button class="btn btn-primary pull-right" id="button" type="submit">Update</button><ul class="list-inline"><li><a href="photo_status.php"><i class="fa fa-camera"></i></a></li><li><a href=""><i class="fa fa-map-marker"></i></a></li></ul>
                                  </form>
                              </div>                           
                             <!--  <div class="panel panel-default">
                                      ...
                                      <a href="" class="list-group-item">Data Grids</a>
														...
														<!--Start of Posts block-->
														        <?php
														          ...
														          $email = $_SESSION['email'];
														          $status = "SELECT * FROM status WHERE country='$country'ORDER BY status_id DESC limit 3 " ;
										                           ...
										                           <hr>
									                                ...
									                                <a href='../controller/sessions/comment_status_session.php?status_id=$status_id'>
														                    ...
														                    ";
																						...
																						$get_comments = "SELECT * FROM comments WHERE status_id = '$status_id'ORDER BY id ASC";
																						...
																						<span style='font-size:smaller;'><b>{$row['fname']} {$row['lname']}</b> said:
																						<font color='blue'>{$row['status']}</font> </span> &nbsp ";
																						if($email == $commenter_email)
																						{
																						  echo"<a href='edit_main_status_comment.php?id=$id'><i class='fa fa-edit'></i></a>";
																						  echo"&nbsp &nbsp<a href='delete_main_status_comment.php?id=$id'><i class='fa fa-scissors'></i></a></div>";
																						}
																						}
														                ...
														                <hr>
														       					<form method='post' action='comment_main_status.php'>
							                                    <div class='input-group'>
							                                      <div class='input-group-btn'>
							                                      </div>
							                                      <input type='text' name='status' class='form-control' placeholder='Add a comment..''>
							                                      <input type='hidden' name='status_id' value='$status_id'>
																  							  	<input type='hidden' name='status_owner' value='$status_email'>
							                                      <div class='input-group-btn'>
				                                   ...
				                                   <hr>
						                                      ...
						                                      <a href='see_likes.php?status_id=$photo_id'>
						                                      	...
						                                      	<button class='btn btn-default'><i class='fa fa-heart'></i></button>
														                ...
														                $get_comments = "SELECT * FROM comments WHERE status_id = '$photo_id'ORDER BY status_id DESC";
																						...
																						if($email==$commenter_email)
																						{
																						 echo"<a href='edit_comment_photo.php?id=$id'><i class='fa fa-edit'></i></a>";
																						 echo"&nbsp &nbsp<a href='delete_comment_photo.php?id=$id'><i class='fa fa-scissors'></i></a>";
				                                    ...
				                                    <div class='input-group'>
				                                      ...
				                                      <input type='text' name='status' class='form-control' placeholder='Add a comment..''>
				                                      <input type='hidden' name='status_id' value='$photo_id'>
													  							  	<input type='hidden' name='status_owner' value='$photo_email'>
				                                      <div class='input-group-btn'>
				                                      <button type='submit' class='btn btn-default'><i class='fa fa-comment'></i></button>
				                                      </div>
				                                    </div>
 ...
 <!--End of Country of visit Updates-->
