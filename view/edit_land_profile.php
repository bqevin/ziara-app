...
while($row=mysql_fetch_array($retval,MYSQL_ASSOC))
{
  ...
  echo"
  <form method='post'action='../controller/action/edit_land_profile_action.php'>
 <font color='orange'>Name:</font><br><input type='text'name='company'value='{$row['company']}'><br>
 ...
 <font color='orange'>Price In Dollars:</font><br><input type='text'name='price'value='{$row['price']}'><br>
