                    ...
                    <div class="full col-sm-9">
                        ...
                        <!-- content -->                      
                         ...
                         <?php
												...
												?>
                              <div class="well"> 
                                   <form class="form-horizontal" method="post" role="form" action="add_photo_status_action.php"enctype="multipart/form-data">
                                    <h4>Upload a pic</h4>
                                    ...
                                    <button class="btn btn-primary pull-right" id="button" name="sumit" type="submit">upload</button><ul class="list-inline"><li><a href="photo_status.php"><i class="fa fa-camera"></i></a></li><li><a href=""><i class="fa fa-map-marker"></i></a></li></ul>
                                  </form>
                              </div>                           
                              <!-- <div class="panel panel-default">
