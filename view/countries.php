...
div.carousel-caption{
    background: rgba(9, 126, 76, 0.82) none repeat scroll 0% 0%;
}
...
<div class="container">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner" role="listbox">
                            <div class="item active">
                              <img src="../img/html_bg2.jpg" alt="1">
                              <div class="carousel-caption">
                                <h3> See what others have posted about different countries </h3>
                              </div>
                            </div>
                            <div class="item">
                              <img src="../img/html_bg3.jpg" alt="2">
                              <div class="carousel-caption">
                               <h3> Share information about your country </h3>
                              </div>
                            </div>
                            <div class="item">
                              <img src="../img/html_bg1.jpg" alt="2">
                              <div class="carousel-caption">
                                <h3> Launch a campaign in a country </h3>
                              </div>
                            </div>
                            <div class="item">
                            ...
                            <div class="item">
                              ...
                              <div class="carousel-caption">
                               <h3>  Sky rocket your education,career,business..and many more! </h3>
                              </div>
                            </div>
                            <div class="item">
                              <img src="../img/html_bg4.jpg" alt="2">
                              <div class="carousel-caption">
                              <h3> ...find a spouse,adopt a child... </h3>
                              </div>
                            </div>
                    ...
                    <div class="col-lg-7 col-lg-offset-1">
                        <div class="well bs-component text-center">
                            ...
                            <form class="form-horizontal" method="post" action="../controller/action/countries_action.php">
                                <fieldset>
                                    <legend>Pick country to visit</legend>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10 col-lg-offset-2">
                                            ...
                                            <button type="submit" class="btn btn-primary">Visit <i style="color:inherit;" class="mdi-av-play-circle-outline"></i></button>
                                        </div>
                                    </div>
                                </fieldset>
                            </form>
