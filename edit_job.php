...
<?php
$job_id = $_POST['job_id'];
$qry = "SELECT * FROM jobs WHERE service_id='$job_id'";
...
while($row = mysql_fetch_array($results,MYSQL_ASSOC))
{
  ...
  echo"<form method='post'action='edit_job_action.php'>
  <span id='span'>Name Of Company:</span><br><input type='text'name='fname'value='$fname'id='input'><br>
