...
<body style="background-image:url(shading.png);background-repeat:repeat;width:100%;"link="red"alink="lightgreen"vlink="darkgreen"/>
...
?>
<p><?php echo $_SESSION['fname'];?> please fill in the information required in the form below.It will help service providers in country's you visit
know how to handle you and services and attention you require to fullfill your satisifaction.</p></td></tr></table>
...
<form method="post"action="add_info_action.php">
...
<font color="red">Places You Have Been:</font><br><textarea rows="5"cols="40"placeholder="Places You Have Been..."name="places"style="border-radius:8px;"maxlength="300"/></textarea><br>
<font color="red">About You:</font><br><textarea rows="5"cols="40"placeholder="About You.."name="about"style="border-radius:8px;"maxlength="1000"/></textarea><br>
