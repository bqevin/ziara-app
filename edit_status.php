...
$get_comment = "SELECT * FROM status WHERE status_id='$status_id'";
...
while($row = mysql_fetch_array($results,MYSQL_ASSOC))
{
 ...
 $status = $row['status'];
   ...
   <span id='span'><br><textarea rows='5'cols='40'style='border-color:black;border-radius:5px;'name='status'>$status</textarea></span><br>
