...
while($row = mysql_fetch_array($retval,MYSQL_ASSOC))
{
  ...
  echo"
  <form method='post'action='edit_event_action.php'>
  <span id='span'>Event By:</span><br><input type='text'id='input'value='$owner' name='owner'><br>
...
<option value='2017'>2017</option></select><br>
...
<input type='submit'value='Done'id='submit'></form>";
}
