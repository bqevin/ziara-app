...
<td align="left">
<p>
<form method="post"action="edit_campaign_profile_pic_action.php"enctype="multipart/form-data">
<input type="hidden"name="campaign_id"value=<?php echo $campaign_id;?>>
<input type="file"name="image">
<input type="submit"name="sumit"value="upload"style="background-color:cyan;color:red;"></form>
</p>
