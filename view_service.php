...
$get = "SELECT * FROM service WHERE service_id='$service_id'";
...
<td width="7.5%"><a href="Profile.php">Profile</a></td><td width="2.5%"></td>
<td width="7.5%"><a href="Posts.php">Posts</a></td><td width="2.5%"></td>
<td width="7.5%"><a href="Messages.php">Messages</a></td><td width="2.5%"></td>
<td width="7.5%"><a href="Friends.php">Friends</a></td><td width="2.5%"></td>
<td width="7.5%"><a href="Notifications.php">Notifications</a></td><td width="2.5%"></td>
<td width="7.5%"><a href="your_campaigns.php">Campaigns</a></td><td width="2.5%"></td>
<td width="7.5%"><a href="your_events.php">Events</a><td width="2.5%">
</td></tr></table>
<div id="para"align="center">
...
while($row=mysql_fetch_array($retval,MYSQL_ASSOC))
{
  ...
  echo"<font color='orange'>Name:</font><font color='blue'>{$row['business']}</font><br>
	  ...
	  {
	  echo"<form method='post'action='message_service_admin.php'>
